...
<body>
	...
	<form>
		...
		<h2 align="center">New Panchayath</h2>
	<div class="bg-light rounded h-100 p-4">
		<table width="900" class="table table-hover">
			...
			<?php 
			$sel = "select * from tbl_pajayathe where pajayathe_status = '0'";
			$res = $con->query($sel);
			if($res->num_rows!=NULL)
			{
				...
				while($row = $res->fetch_assoc())
				{
					...
					<tr>
						...
						<td class="btn btn-outline-primary m-2"><a href="New_panjayathe.php?upid=<?php echo $row["pajayathe_id"]; ?>">Approved</a></td>
					</tr>
					<?php
				}
			}
