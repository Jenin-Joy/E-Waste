...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="../Guest/Template/assets/img/favicon.ico">
                           ...
                           <div class="single-footer-caption mb-50">
                               <div class="single-footer-caption mb-30">
                                   ...
                                   <div class="footer-logo mb-35">
                                       <a href="../Guest/Template/index.php"><img src="../Guest/Template/assets/img/logo/logo2_footer.png" alt=""></a>
                                   </div>
                               ...
                               <div class="footer-tittle">
                                   ...
                                   <ul>
                                      <li><a href="../Guest/Login.php">Login</a></li>
                                       <li><a href="../Guest/New_user.php">Register</a></li>
                                       <li><a href="../Guest/Template/about.html">About</a></li>
                                   </ul>
                               </div>
                           </div>
                       </div>
